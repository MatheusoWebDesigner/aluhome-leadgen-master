...
const Products = () => {
  ...
  return <section className="py-20 bg-muted">
      <div className="container mx-auto px-6">
        <h2 className="text-center md:text-left text-foreground mb-4 text-2xl">
        ...
        <div className="flex flex-col sm:flex-row flex-wrap justify-center md:justify-start gap-4">
          <Button variant="hero" size="lg" onClick={() => window.open('https://wa.me/5511920339135?text=Olá!%20Gostaria%20de%20mais%20informações%20sobre%20suas%20portas%20de%20alumínio.', '_blank')}>
            Saber mais sobre Portas
          </Button>
          <Button variant="hero" size="lg" onClick={() => window.open('https://wa.me/5511920339135?text=Olá!%20Gostaria%20de%20mais%20informações%20sobre%20suas%20venezianas%20de%20alumínio.', '_blank')}>
            Saber mais sobre Venezianas
          </Button>
          <Button variant="hero" size="lg" onClick={() => window.open('https://wa.me/5511920339135?text=Olá!%20Gostaria%20de%20mais%20informações%20sobre%20seus%20vitros%20de%20alumínio.', '_blank')}>
