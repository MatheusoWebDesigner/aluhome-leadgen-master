...
const ProblemSolution = () => {
  ...
  return <section className="py-20 bg-muted">
      <div className="container mx-auto px-6">
        {/* Problem Section */}
        <div className="mb-16">
          <h2 className="text-center text-foreground mb-12 text-4xl my-[40px]">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-primary text-primary-foreground rounded-2xl p-10 md:p-16 shadow-elegant">
